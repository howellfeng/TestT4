...
<misControl:LabelItem Label="创建日期：">
    <TextBlock Text="{Binding Data.Info.create_date,Mode=OneWay,StringFormat='{}{0:yyyy-MM-dd HH:mm:ss}'}"/>
...
<misControl:LabelItem Label="更新日期：">
    <TextBlock Text="{Binding Data.Info.update_date,Mode=OneWay,StringFormat='{}{0:yyyy-MM-dd HH:mm:ss}'}"/>
</misControl:LabelItem>
...
<misControl:LabelItem Label="是否集装箱班轮运输：" Content="{Binding Data.Info.has_container,Mode=OneWay,Converter={StaticResource bool2String}}"/>
<misControl:LabelItem Label="本船经营范围是否过闸：" Content="{Binding Data.Info.has_sluice,Mode=OneWay,Converter={StaticResource bool2String}}"/>
...
<misControl:LabelItem Label="建成日期：">
    <TextBlock Text="{Binding Data.Info.build_date,Mode=OneWay,StringFormat='{}{0:yyyy-MM-dd HH:mm:ss}'}"/>
</misControl:LabelItem>
<misControl:LabelItem Label="改建日期：">
    <TextBlock Text="{Binding Data.Info.remould_date,Mode=OneWay,StringFormat='{}{0:yyyy-MM-dd HH:mm:ss}'}"/>
</misControl:LabelItem>
...
<misControl:LabelItem Label="是否符合内河尺寸标准：" Content="{Binding Data.Info.has_riverboat_norm,Mode=OneWay,Converter={StaticResource bool2String}}"/>
...
<misControl:LabelItem Label="船舶营运证到期时间：">
    <TextBlock Text="{Binding Data.Info.expire_time,Mode=OneWay,StringFormat='{}{0:yyyy-MM-dd HH:mm:ss}'}"/>
</misControl:LabelItem>
